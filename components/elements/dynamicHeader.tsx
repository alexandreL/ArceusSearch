    ...
    return (
        <>
            <div className="bg-neutral flex flex-row">
                {
                    gptAnswer && <div className="min-h-12 card bg-neutral-focus m-1 basis-1/3">
                ...
                {
                    wikiAnswer?.title && <div className="min-h-12 card bg-neutral-focus m-1 basis-1/3">
                        <div className="card-body">
                ...
                }
                {
                    mathAnswer && <div className="min-h-12 card bg-neutral-focus m-1 basis-1/3">
                        <div className="card-body">
                            <h2 className="card-title">mathAnswer</h2>
